...
export default function Navbar() {
  ...
  return (
    <motion.header
      ...
      className="fixed top-0 left-0 right-0 z-50 w-full backdrop-blur-xl bg-white/20 dark:bg-black/20 border-b border-neutral-200/50 dark:border-neutral-800/50"
    >
