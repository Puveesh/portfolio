  ...
  <AnimatePresence mode="popLayout">
    {filteredProjects.map((project) => (
      <motion.div
        ...
        whileHover={{ y: -6 }}
        className="flex flex-col overflow-hidden rounded-xl border border-neutral-200/60 dark:border-neutral-800/80 bg-neutral-50/20 dark:bg-neutral-950/20 shadow-sm hover:shadow-md transition-all duration-200 glassmorphism"
      >
        {/* Thumbnail */}
        ...
        <div className="flex flex-col p-6 flex-grow">
          ...
          {/* Footer */}
          <div className="flex flex-wrap items-center gap-4 border-t border-neutral-200/50 dark:border-neutral-800/50 pt-4 mt-auto">
            ...
            <a
              ...
              className="inline-flex items-center gap-1 text-xs text-neutral-500 hover:text-black dark:text-neutral-400 dark:hover:text-white font-semibold transition-colors duration-200"
            >
              <Github size={12} />
              <span>Repository</span>
            </a>

            {/* Live Site OR Amazon Nova */}
            {project.liveUrl ? (
              <a
              ...
              <div className="inline-flex items-center gap-2 rounded-full bg-orange-500/10 border border-orange-500/20 px-3 py-1">
                <img
                  src={project.liveLogo}
                  alt="Amazon"
